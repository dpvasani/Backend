    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-red-500 to-red-600 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-white p-12">
          ...
          <h1 className="text-4xl font-bold mb-4">Welcome to YouTweet</h1>
          <p className="text-xl text-center text-red-100 max-w-md">
            Share your videos, connect with creators, and discover amazing content from around the world.
          </p>
          <div className="mt-12 grid grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-red-200">Creators</div>
            </div>
            <div>
              <div className="text-3xl font-bold">10M+</div>
              <div className="text-red-200">Views</div>
            </div>
          </div>
        </div>
        {/* Decorative elements */}
